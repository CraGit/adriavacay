                ...
                <div className="">
                  ...
                  <div className="mt-6">
                    ...
                    <p className="text-slate-400 mt-3">
                      ...
                      step. adriaVacay streamlines the Loan Pre-Approval process
              ...
              {activeTabIndex === 1 && (
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="text-slate-400 mt-3">
                      adriaVacay allows a buyer to schedule an instant showing
                      and gain a private viewing without the need for multiple
              ...
              {activeTabIndex === 2 && (
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="text-slate-400 mt-3">
                      adriaVacay walks a buyer through the purchase agreement
              ...
              {activeTabIndex === 4 && (
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="text-slate-400 mt-3">
                      adriaVacay monitors the appraisal process ensuring the
                      home you are purchasing meets or exceeds the price you are
                      paying.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="text-slate-400 mt-3">
                      ...
                      and the day has come… You have adriaVacay the home of your
                      dreams!
                    </p>
                  </div>
                </div>
